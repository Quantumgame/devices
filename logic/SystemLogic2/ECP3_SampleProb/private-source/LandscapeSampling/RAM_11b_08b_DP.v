...
/* Module Version: 6.5 */
/* C:\lscc\diamond\3.6_x64\ispfpga\bin\nt64\scuba.exe -w -n RAM_11b_08b_DP -lang verilog -synth lse -bus_exp 7 -bb -arch ep5c00 -type bram -wp 10 -rp 0011 -rdata_width 11 -data_width 11 -num_rows 256 -cascade 11  */
/* Tue Mar 22 15:00:35 2016 */


`timescale 1 ns / 1 ps
module RAM_11b_08b_DP (WrAddress, RdAddress, Data, WE, RdClock, 
    ...
    defparam RAM_11b_08b_DP_0_0_0_0.CSDECODE_B = "0b000" ;
    defparam RAM_11b_08b_DP_0_0_0_0.CSDECODE_A = "0b000" ;
    defparam RAM_11b_08b_DP_0_0_0_0.WRITEMODE_B = "NORMAL" ;
    defparam RAM_11b_08b_DP_0_0_0_0.WRITEMODE_A = "NORMAL" ;
    defparam RAM_11b_08b_DP_0_0_0_0.GSR = "DISABLED" ;
    defparam RAM_11b_08b_DP_0_0_0_0.REGMODE_B = "NOREG" ;
    defparam RAM_11b_08b_DP_0_0_0_0.REGMODE_A = "NOREG" ;
    defparam RAM_11b_08b_DP_0_0_0_0.DATA_WIDTH_B = 18 ;
    defparam RAM_11b_08b_DP_0_0_0_0.DATA_WIDTH_A = 18 ;
    DP16KC RAM_11b_08b_DP_0_0_0_0 (.DIA0(Data[0]), .DIA1(Data[1]), .DIA2(Data[2]), 
        ...
        .ADB11(RdAddress[7]), .ADB12(scuba_vlo), .ADB13(scuba_vlo), .CEB(RdClockEn), 
        .CLKB(RdClock), .OCEB(RdClockEn), .WEB(scuba_vlo), .CSB0(scuba_vlo), 
        ...
        .DOB10(Q[10]), .DOB11(), .DOB12(), .DOB13(), .DOB14(), .DOB15(), 
        .DOB16(), .DOB17())
             /* synthesis MEM_LPC_FILE="RAM_11b_08b_DP.lpc" */
    ...
    // exemplar begin
    // exemplar attribute RAM_11b_08b_DP_0_0_0_0 MEM_LPC_FILE RAM_11b_08b_DP.lpc
    // exemplar attribute RAM_11b_08b_DP_0_0_0_0 MEM_INIT_FILE 
    // exemplar attribute RAM_11b_08b_DP_0_0_0_0 RESETMODE SYNC
    // exemplar end
