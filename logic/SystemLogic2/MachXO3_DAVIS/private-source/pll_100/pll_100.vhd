...
-- Module  Version: 5.7
--C:\lscc\diamond\3.9_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_100 -lang vhdl -synth synplify -arch xo3c00a -type pll -fin 80 -fclkop 100 -fclkop_tol 0.0 -trimp 0 -phasep 0 -trimp_r -phase_cntl STATIC -rst -fb_mode 1 -lock 
...
begin
    ...
    PLLInst_0: EHXPLLJ
        ...
        CLKOS_DIV=>  1, CLKOP_DIV=>  5, CLKFB_DIV=>  5, CLKI_DIV=>  4, 
        FEEDBK_PATH=> "CLKOP")
